...
module GPSKinMPCPathFollower
    ...
    C_psi = 100			# heading deviation
    C_v   = 0.0				# target velocity deviation

	C_dacc	 = 500			# derivative of acceleration input
	C_ddf	 = 100			# derivative of tire angle input
	C_acc	 = 0.0			# acceleration input
	C_df	 = 0.0			# tire angle input
