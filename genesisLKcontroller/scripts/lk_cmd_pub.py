...
##########Main loop ############################################################################
	while not rospy.is_shutdown():
		...
		print('Steer Command: %f deg \t Accel Command: %f ms2 \t Time: %f seconds' % (delta, accel, dt_secs))
...
if __name__=="__main__":
	try:
		parser = argparse.ArgumentParser('Run lanekeeping controller from VSD 2015 paper')
