...
disp('1')
h1 = plot(xLA, UxC,'LineWidth',2); grid on; hold on;

[xLA UxC] = getStability(1,1.5,'lk');
disp('2')
plot(xLA, UxC,'LineWidth',2); grid on; hold on;
...
disp('4')
h2 = plot(xLA, UxC,'r--','LineWidth',2); grid on; hold on;

[xLA UxC] = getStability(1,1.5,'beta');
disp('5')
plot(xLA, UxC,'r--','LineWidth',2); grid on; hold on;
...
legend([h1 h2], {'Lanekeeping FB','Velocity Vector FB'})
tightfig
